...
describe("SessionsPerStation", function () {
    ...
    it('no station id ',function (done) {
        this.timeout(5000)

        SessionsPerStation = (undefined,"2019-08-01 20:14:17","2019-08-01 22:01:04",apikey)
        setTimeout(()=>{
            expect(consoleOutput).to.be.deep.equal(["Please Provide a station Id"])
            done()
        },1000)
